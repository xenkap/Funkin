...
class SongMenuItem extends FlxSpriteGroup
{
  ...
  public function refreshDisplay(updateRank:Bool = true, isLevelDisplay:Bool = false):Void
  {
  ...
  public function init(?x:Float, ?y:Float, freeplayData:Null<FreeplaySongData>, ?styleData:FreeplayStyle = null, ?index:Int, isLevelDisplay:Bool = false):Void
  {
    if (x != null) this.x = x;
    if (y != null) this.y = y;
